...
//                openReplyNotifacation(event);
                break;
            case AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED:  // 打开一个popup或者dialog
    ...
    private boolean fill() {
        ...
        if (rootNode != null) {
            ...
            return pasteMessageInEditText(rootNode, scontent.toUpperCase());
        }
        return false;
    }
